...
if __name__=="__main__":
    ...
    # train dataset        
    images_dir = os.path.join(root,'part_A/train_data','images') 
    mat_dir = os.path.join(root,'part_A/train_data','ground-truth')
    out_dir = os.path.join(root,'part_A/train_data','ground-truth_dots')
    scale = 1    
    ...
    out_dir = os.path.join(root,'part_A/test_data','ground-truth_dots')
    scale = 1    
