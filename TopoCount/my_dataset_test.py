...
class CrowdDataset(Dataset):
    ...
    def __init__(self, img_root, gt_dot_root, split_txt_filepath=None, phase='train', aug=0, normalize=True,
                 fixed_size=-1, max_side=-1):
        '''
    ...
    def __getitem__(self, index):
        ...
        if max_scale > 1:  # fix image and gt to match model.
            ...
            gt_dot = np.pad(gt_dot, ((pad_y1, pad_y2), (pad_x1, pad_x2)), 'constant',
