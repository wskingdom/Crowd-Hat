...
def augmentation_crop_count(count):
    crop_count = 6 if count == 0 else 2 if 0 < count < 100 else 4 if 100 <= count < 200 else 8 if 200 <= count < 500 else 12 \
        if 500 <= count < 1000 else 16 if 1000 <= count < 2500 else 24 if 2500 <= count < 5000 else 32
